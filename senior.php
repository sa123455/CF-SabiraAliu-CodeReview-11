...
$resSen = mysqli_query($conn, "SELECT * FROM pet WHERE age >= 8 ");
...
<div class="col-6 mt-3 p-4 text-white ">
		   ...
		   <a class="text-white weight-bold" href="home.php">HOME</a><br>
		   
		   </div>
		   </div>
		   </div>
		   <a class="text-white weight-bold" href="baby.php"><button class="btn btn-danger">Visit our Babies here!</button></a>
